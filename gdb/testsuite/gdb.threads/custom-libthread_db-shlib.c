...
#endif
#ifdef __x86_64__
  static const char libthread_db_path[]
...
#define LIBTHREAD_DB_FUNCTION(symbol)                                         \
  ...
  if (symbol##_orig == NULL)                                                  \
    {                                                                         \
      fprintf (stderr,                                                        \
               "FATAL: Failed to resolve symbol '" #symbol                    \
               "' due to '%s'.\n",                                            \
               dlerror ());                                                   \
      abort ();                                                               \
    }
...
#endif
  my_prochandle = __ps;
  ps_err_e e = ps_pglobal_lookup (__ps, NULL, "_thread_db_userspace_threads",
...
#if PRINT_LOGGING
  printf ("custom-libthread_db: _thread_db_userspace_threads in inferior was "
          "resolved to %p\n",
...
LIBTHREAD_DB_EXTERN td_err_e
td_ta_map_lwp2thr (td_thragent_t const *ta_p, lwpid_t lwpid,
                   td_thrhandle_t *th_p)
{
#if PRINT_LOGGING
  ...
  return thread_db_userspace_threads_td_ta_map_lwp2thr (td_ta_map_lwp2thr_orig,
                                                        ta_p, lwpid, th_p);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_thr_iter (td_thragent_t const *ta_p, td_thr_iter_f *cb, void *cbdata_p,
                td_thr_state_e state, int ti_pri, sigset_t *ti_sigmask_p,
                unsigned ti_user_flags)
{
#if PRINT_LOGGING
  printf ("custom-libthread_db: td_ta_thr_iter cbdata_p = %p state = %d\n",
          cbdata_p, state);
#endif
  ps_err_e e
      = thread_db_userspace_threads_read_current_thread_db_userspace_threads (
  ...
  return thread_db_userspace_threads_td_ta_thr_iter (
      td_ta_thr_iter_orig, ta_p, cb, cbdata_p, state, ti_pri, ti_sigmask_p,
      ti_user_flags);
}
...
LIBTHREAD_DB_EXTERN td_err_e
td_thr_getgregs (const td_thrhandle_t *__th, prgregset_t __gregs)
{
#if PRINT_LOGGING
  printf ("custom-libthread_db: td_thr_getgregs\n");
#endif
  return thread_db_userspace_threads_td_thr_getgregs (td_thr_getgregs_orig,
                                                      __th, __gregs);
}
...
LIBTHREAD_DB_EXTERN const char **
td_symbol_list (void)
{
...
LIBTHREAD_DB_EXTERN td_err_e
td_ta_delete (td_thragent_t *__ta)
{
  return td_ta_delete_orig (__ta);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_get_nthreads (const td_thragent_t *__ta, int *__np)
{
  return td_ta_get_nthreads_orig (__ta, __np);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_get_ph (const td_thragent_t *__ta, struct ps_prochandle **__ph)
{
  return td_ta_get_ph_orig (__ta, __ph);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_map_id2thr (const td_thragent_t *__ta, pthread_t __pt,
                  td_thrhandle_t *__th)
{
...
LIBTHREAD_DB_EXTERN td_err_e
td_ta_tsd_iter (const td_thragent_t *__ta, td_key_iter_f *__ki, void *__p)
{
  return td_ta_tsd_iter_orig (__ta, __ki, __p);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_event_addr (const td_thragent_t *__ta, td_event_e __event,
                  td_notify_t *__ptr)
{
...
LIBTHREAD_DB_EXTERN td_err_e
td_ta_set_event (const td_thragent_t *__ta, td_thr_events_t *__event)
{
  return td_ta_set_event_orig (__ta, __event);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_clear_event (const td_thragent_t *__ta, td_thr_events_t *__event)
{
  return td_ta_clear_event_orig (__ta, __event);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_event_getmsg (const td_thragent_t *__ta, td_event_msg_t *__msg)
{
  return td_ta_event_getmsg_orig (__ta, __msg);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_setconcurrency (const td_thragent_t *__ta, int __level)
{
  return td_ta_setconcurrency_orig (__ta, __level);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_enable_stats (const td_thragent_t *__ta, int __enable)
{
  return td_ta_enable_stats_orig (__ta, __enable);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_reset_stats (const td_thragent_t *__ta)
{
  return td_ta_reset_stats_orig (__ta);
}

LIBTHREAD_DB_EXTERN td_err_e
td_ta_get_stats (const td_thragent_t *__ta, td_ta_stats_t *__statsp)
{
  return td_ta_get_stats_orig (__ta, __statsp);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_validate (const td_thrhandle_t *__th)
{
  return td_thr_validate_orig (__th);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_getfpregs (const td_thrhandle_t *__th, prfpregset_t *__regset)
{
  return td_thr_getfpregs_orig (__th, __regset);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_getxregs (const td_thrhandle_t *__th, void *__xregs)
{
  return td_thr_getxregs_orig (__th, __xregs);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_getxregsize (const td_thrhandle_t *__th, int *__sizep)
{
  return td_thr_getxregsize_orig (__th, __sizep);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_setfpregs (const td_thrhandle_t *__th, const prfpregset_t *__fpregs)
{
  return td_thr_setfpregs_orig (__th, __fpregs);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_setgregs (const td_thrhandle_t *__th, prgregset_t __gregs)
{
  return td_thr_setgregs_orig (__th, __gregs);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_setxregs (const td_thrhandle_t *__th, const void *__addr)
{
  return td_thr_setxregs_orig (__th, __addr);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_tlsbase (const td_thrhandle_t *__th, unsigned long int __modid,
                psaddr_t *__base)
{
...
LIBTHREAD_DB_EXTERN td_err_e
td_thr_tls_get_addr (const td_thrhandle_t *__th, psaddr_t __map_address,
                     size_t __offset, psaddr_t *__address)
{
  return td_thr_tls_get_addr_orig (__th, __map_address, __offset, __address);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_event_enable (const td_thrhandle_t *__th, int __event)
{
  return td_thr_event_enable_orig (__th, __event);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_set_event (const td_thrhandle_t *__th, td_thr_events_t *__event)
{
  return td_thr_set_event_orig (__th, __event);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_clear_event (const td_thrhandle_t *__th, td_thr_events_t *__event)
{
  return td_thr_clear_event_orig (__th, __event);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_event_getmsg (const td_thrhandle_t *__th, td_event_msg_t *__msg)
{
  return td_thr_event_getmsg_orig (__th, __msg);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_setprio (const td_thrhandle_t *__th, int __prio)
{
  return td_thr_setprio_orig (__th, __prio);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_setsigpending (const td_thrhandle_t *__th, unsigned char __n,
                      const sigset_t *__ss)
{
...
LIBTHREAD_DB_EXTERN td_err_e
td_thr_sigsetmask (const td_thrhandle_t *__th, const sigset_t *__ss)
{
  return td_thr_sigsetmask_orig (__th, __ss);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_tsd (const td_thrhandle_t *__th, const thread_key_t __tk, void **__data)
{
  return td_thr_tsd_orig (__th, __tk, __data);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_dbsuspend (const td_thrhandle_t *__th)
{
  return td_thr_dbsuspend_orig (__th);
}

LIBTHREAD_DB_EXTERN td_err_e
td_thr_dbresume (const td_thrhandle_t *__th)
{
